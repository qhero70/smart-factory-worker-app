...
此 GitHub 專案已整理為乾淨正式版，目前版本：**v1.5.3｜報工作業v2化新班別版分流**。
...
- `docs/work-report-v2-submit.js` 的送出報工已改呼叫 `寫入報工作業v2_化新班別版`
- `docs/work-report-v2.html` 已更新 JS 版本號為 `20260610_01`，避免 GitHub Pages 快取舊版
- `智慧製造中央作戰指揮中心.gs` 已新增 Web API action 分流：`寫入報工作業v2_化新班別版`
- `寫入報工作業v2_化新班別版(p)` 已加入必填檢查、化新班別判斷、報工寫入與工單回扣
