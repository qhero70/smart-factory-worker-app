/**
 * v3.7.5 GAS 主控入口與 LINE Webhook 最終整合版
 * 檔案定位：v3 路由模組，不直接宣告 doGet(e) / doPost(e)。
 * 正式入口：保留在「智慧製造中央作戰指揮中心.gs」。
 * 本版修正：LINE「主檔檢查」改為摘要版，不再整包 JSON 回覆。
 */

const V3_0_系統版本 = 'v3.7.5';
...
function 系統總檢查_v3_0() {
  ...
  const 核心工作表 = ['00_系統設定', '01_人員主檔', '02_產品主檔', '03_機台主檔', '04_工站主檔', '09_報工紀錄', '10_工單主檔', '10_排程需求池', '11_檢具主檔', '12_AI分析紀錄', 'LINE_指令設定', '系統_操作紀錄'];
