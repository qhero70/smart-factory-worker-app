...
1. `smart-factory-command-center/01_GAS後端/35_LINE_製造AI助理_ReadOnly_v0.1.gs`
2. `smart-factory-command-center/08_測試與驗收/35_LINE_製造AI助理_v0.1_驗收.gs`
3. `gas/製造AI中央閘道_v0.1.gs`
4. `smart-factory-command-center/01_GAS後端/總控_38_6_doPost最終接線.gs`
