const 快取名稱='huaxin-work-report-v4-cache-494-selected-person-center';
const 預快取清單=[
  './',
  './work-report-v4-477.html?v=494&fix=selected-person-center',
  ...
  './work-report-v4-selected-center-494.js?v=494',
