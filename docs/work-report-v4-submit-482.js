/* 報工作業 V4 submit v4.8.4：寫入 09_報工 / 09_不良紀錄
 * 鎖定正式主資料庫；避免 GAS 已 append 但前端誤判未確認。
 */
(function(){
'use strict';
...
function responseIsSuccess(res){
  ...
  return /成功|完成|已寫入|正式寫入|append|submitted|written/i.test(msg);
}
