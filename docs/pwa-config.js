...
Object.assign(window.PWA_CONFIG,{
  ...
  APP_SHORT_NAME:'化新精密',
  VERSION:'v4.4.9_報工作業V4_最小修正停止亂改UI',
...
(function(){
  ...
  if(isV4Report){
    load('./work-report-v4-sheets-direct-442.js?v='+v,'報工V4正式主庫直讀449');
    load('./work-report-v4-force-formal-440.js?v='+v,'報工V4強制正式主庫接管449');
    load('./work-report-v4-ux-427.js?v='+v,'報工V4正式UX補強449');
    load('./work-report-v4-final-441.js?v='+v,'報工V4正式封口修復449');
    load('./work-report-v4-native-workpiece-446.js?v='+v,'報工V4原生工件流程449');
    load('./work-report-v4-no-random-449.js?v='+v,'報工V4最小修正不亂改UI449');
  }
  if(isApp){
