...
(function (設定) {
  ...
  設定.VERSION = 'v5.2.6-photo-index-api-fix';
  ...
  function 啟用報工修復器() {
    ...
    if (!document.getElementById('hx-photo-display-526')) {
      var c = document.createElement('script');
      c.id = 'hx-photo-display-526';
      c.src = './work-report-v4-photo-display-522.js?v=526';
      c.defer = true;
