...
(function (設定) {
  'use strict';
  設定.GAS_WEB_APP_URL = 'https://script.google.com/macros/s/AKfycby2ghuwkxTr1kbt2bU9D3U24O55c6GhcabA1IhDC67OEw86pH6MjS3nnBMASnjEmggw/exec';
  設定.APP_NAME = '化新精密｜製一組報工作業V4';
  設定.APP_SHORT_NAME = '化新報工';
  設定.VERSION = 'v5.4.4-正式分頁收據防重';
  ...
  設定.SUBMIT_TIMEOUT_MS = 90000;
  設定.REPORT_SHEET = '0_報工對接pwa V4，報工';
  設定.API_ACTIONS = {
    INIT: ['取得報工作業V4初始資料', '取得報工作業v2初始資料'],
    SUBMIT: ['寫入報工V4正式分頁']
  };
  ...
  function 啟用報工修復器() {
    ...
    載入JS('hx-official-lock-533', './work-report-v4-official-lock-533.js?v=544');
