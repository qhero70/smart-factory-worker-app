...
Object.assign(window.PWA_CONFIG,{
  ...
  APP_SHORT_NAME:'化新精密',
  VERSION:'v4.5.0_報工作業V4_工站對接最小修正',
...
(function(){
  ...
  if(isV4Report){
    load('./work-report-v4-sheets-direct-442.js?v='+v,'報工V4正式主庫直讀450');
    load('./work-report-v4-force-formal-440.js?v='+v,'報工V4強制正式主庫接管450');
    load('./work-report-v4-ux-427.js?v='+v,'報工V4正式UX補強450');
    load('./work-report-v4-final-441.js?v='+v,'報工V4正式封口修復450');
    load('./work-report-v4-station-bind-450.js?v='+v,'報工V4工站對接最小修正450');
  }
  if(isApp){
