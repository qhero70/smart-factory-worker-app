...
Object.assign(window.PWA_CONFIG,{
  ...
  APP_SHORT_NAME:'化新精密',
  VERSION:'v4.4.8_報工作業V4_工站卡片半版人員照片產品兩欄',
...
(function(){
  ...
  if(isV4Report){
    load('./work-report-v4-sheets-direct-442.js?v='+v,'報工V4正式主庫直讀448');
    load('./work-report-v4-force-formal-440.js?v='+v,'報工V4強制正式主庫接管448');
    load('./work-report-v4-ux-427.js?v='+v,'報工V4正式UX補強448');
    load('./work-report-v4-final-441.js?v='+v,'報工V4正式封口修復448');
    load('./work-report-v4-native-workpiece-446.js?v='+v,'報工V4原生工件流程448');
    load('./work-report-v4-station-cards-448.js?v='+v,'報工V4工站卡片半版人員照片448');
  }
  if(isApp){
