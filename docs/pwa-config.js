...
(function (設定) {
  ...
  設定.VERSION = 'v5.3.8-final-op-machine-rule';
  ...
  function 啟用報工修復器() {
    ...
    載入JS('hx-route-complete-536', './work-report-v4-route-complete-536.js?v=536');
    載入JS('hx-opfix-534', './work-report-v4-opfix-534.js?v=534');
    載入JS('hx-opselect-538', './work-report-v4-opselect-535.js?v=538');
