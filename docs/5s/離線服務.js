 ...
 * 4. 導航失敗時回首頁或離線頁。
 * 5. v1.1.3 納入 A5 現場照片盤點中心與製一組 1044/1046/1045 現況資料。
 */

const 快取版本 = '化新精密-智慧5S-v1.1.3';
...
self.addEventListener('fetch', 事件 => {
  ...
  const 是否核心腳本 = /智慧5S設定\.js|智慧5S資料庫\.js|智慧5S_Google試算表直讀備援\.js|智慧5S資料修復\.js|智慧5S應用程式\.js|智慧5S_G1整理戰情\.js|智慧5S_主管戰情\.js|智慧5S_區域風險排名\.js|智慧5S_趨勢分析\.js|智慧5S_巡檢覆蓋與今日任務\.js|智慧5S_可視化標準管理\.js|智慧5S_製一組標準展開\.js|智慧5S_A5現場照片盤點\.js|智慧5S_導航擴充修復\.css|智慧5S樣式\.css/.test(網址.pathname);
