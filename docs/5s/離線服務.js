...
self.addEventListener('fetch', 事件 => {
  ...
  const 是否核心腳本 = /智慧5S設定\.js|智慧5S資料庫\.js|智慧5S資料修復\.js|智慧5S應用程式\.js|智慧5S_G1整理戰情\.js|智慧5S_主管戰情\.js|智慧5S_區域風險排名\.js|智慧5S樣式\.css/.test(網址.pathname);
  if (是否核心腳本) {
    事件.respondWith(
      fetch(請求, { cache: 'no-store' })
        .then(回應 => {
